...
def do_training(pathDict, totalEpoch, mname, path):
    ...
    print("===========================")
    print("Reading data")
    dataWithLabel = df.createDataWithLabel('training',pathDict['paths'][0], true_labels, total_images, pathDict['featuretuple'], pathDict['dimensions'][1], pathDict['dimensions'][0])
    print("===========================")
...
def do_testing(mname, pathDict):
    ...
    print("===========================")
    print("Reading data")
    dataWithoutLabel = df.createDataWithLabel('testing',pathDict['paths'][2], true_labels, total_images, pathDict['featuretuple'], pathDict['dimensions'][1], pathDict['dimensions'][0])
    print("===========================")
